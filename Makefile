...
VMWARE_TEMPLATE_FILENAMES = $(filter-out debian6010-i386.json debian6010.json debian75.json debian75-i386.json debian76-i386.json debian76.json debian77-i386.json debian77.json,$(TEMPLATE_FILENAMES))
